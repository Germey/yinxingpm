...
function PasswordWidget(divid,pwdname)
{
	...
	this.txtShow = '显示密码';
	this.txtMask = '隐藏密码';
	this.txtGenerate = '自动生成';
	this.txtWeak='强度:弱';
	this.txtMedium='强度:中等';
	this.txtGood='强度:强';
...
function _MakePWDWidget()
{
	...
	code += "<input type='password' name='"+pwdname+"' id='"+this.pwdfieldid+"'>";

	this.pwdtxtfield=pwdname+"_text";

	this.pwdtxtfieldid = this.pwdtxtfield+"_id";

	code += "<input type='text'  name='"+this.pwdtxtfield+"' id='"+this.pwdtxtfieldid+"' style='display: none;'>";
