...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        updateResults: function (initial) {
            ...
            opts.query({
                ...
                if ((data.results == null || data.results.length === 0) && checkFormatter(opts.formatNoMatches, "formatNoMatches")) {
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "无符合条件"; },
        formatInputTooShort: function (input, min) { return "请再输入 " + (min - input.length) + " 个字符"; },
        formatSelectionTooBig: function (limit) { return "只能选择 " + limit + " 项" + (limit == 1 ? "" : ""); },
        formatLoadMore: function (pageNumber) { return "正在加载更多内容..."; },
