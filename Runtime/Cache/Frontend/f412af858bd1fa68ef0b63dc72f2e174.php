...
<div id="content" class="wide project-detail">
  ...
  <?php  $isAdmin = auditEditable($login_user['role']); ?>
...
<div>
    ...
    <span style="padding-left:20px;">
      <?php if(!$isAdmin): ?><a href="#" id="change_status" data-type="select" data-pk="<?php echo ($user['id']); ?>" data-url="/user/ajax_save_status" data-title="修改状态">
