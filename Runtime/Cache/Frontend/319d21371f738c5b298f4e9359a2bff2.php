...
<div id="content" class="wide">
    <h4><?php echo (L("setting")); ?></h4>
    <hr>
    <div class="setting">
        <?php if($login_user['user_group']['role'] == 'admin'): ?><!-- <div class="span2"><a href="__URL__/group_list" class="btn btn-large"><?php echo (L("group_setting")); ?></a></div> -->
            <div class="span2"><a href="__URL__/user_list" class="btn btn-large"><?php echo (L("user_setting")); ?></a></div>
            ...
            <!-- <div class="span2"><a href="/adminlog" class="btn btn-large">操作日志</a></div> --><?php endif; ?>
        <div class="span2"><a href="__URL__/password_edit" class="btn btn-large ajaxlink"><?php echo (L("edit_password")); ?></a></div>
    </div>
</div>
</div>
<div class="clear"></div>
