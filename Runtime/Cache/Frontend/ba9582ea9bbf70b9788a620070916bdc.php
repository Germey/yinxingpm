...
<div id="content" class="wide">
    ...
    <table class="table table-striped table-hover home-tb">
      <tr>
        ...
        <td class="r"><?php echo ($partner_count); ?></td>
      </tr>
    </table>

    <table class="stat">

        <?php  $column = array("银杏伙伴省份","人数"); $stat_type_name = '银杏伙伴省份分布'; $key_stat_type_key = 'partner-province-rank'; $table_value = $partner_province_rank; ?>
...
<tr>
        ...
        <?php
 $column = array("银杏伙伴性别","人数"); $stat_type_name='银杏伙伴性别比例统计排名'; $key_stat_type_key = 'partner-gender-rank'; $table_value = $partner_gender_rank; ?>
...
$(function () {
    ...
    $('#partner-gender-rank-chart').highcharts({
        ...
        series: [{
            type: 'pie',
            name: '人数',
            data: <?php echo array_to_pie_chart_json($partner_gender_rank);?>
        }]
    });
    ...
    $('#partner-province-rank-chart').highcharts({
        ...
        title: { text: '银杏伙伴省份分布' },
        xAxis: [{
            categories: <?php echo json_encode(array_keys($partner_province_rank));?>
        }],
        yAxis: [{ 
            labels: {
                format: '{value}个',
        ...
        series: [{
            ...
            color: '#4572A7',
            type: 'column',
            data: <?php echo array_to_pie_chart_json($partner_province_rank);?>,
            tooltip: {
                valueSuffix: '个'
            }
        }]
